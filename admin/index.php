...
<head>
    ...
    <title>Greenway - Admin Dashboard</title>
                            ...
                            <div class="custome-1-bg b-r-4 card-body">
                                <div class="media align-items-center static-top-widget">
                                    <div class="media-body p-0">
                                        ...
                                        <h4 class="mb-0 counter">Rs.<?= MySQL::search("SELECT SUM(amount) as amount FROM invoice")->fetch_assoc()["amount"] ?>
                                            <span class="badge badge-light-primary grow">
                                                    <i data-feather="trending-up"></i>8.5%</span>
                                        </h4>
                                    </div>
                                    <div class="align-self-center text-center">
                                        <i data-feather="database" style="color: #E94B6E"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class=" custome-2-bg  b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        ...
                                        <h4 class="mb-0 counter"><?= MySQL::search("SELECT COUNT(*) as count FROM invoice")->fetch_assoc()["count"] ?>
                            ...
                            <div class=" custome-3-bg b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        ...
                                        <h4 class="mb-0 counter"><?= MySQL::search("SELECT COUNT(*) as count FROM reviews")->fetch_assoc()["count"] ?>
                                    ...
                                    <div class="align-self-center text-center">
                                        <i data-feather="message-circle" style="color: #EF3F3F"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class=" custome-4-bg b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        ...
                                        <h4 class="mb-0 counter"><?= MySQL::search("SELECT COUNT(*) as count FROM user")->fetch_assoc()["count"] ?>
                        ...
                        <div class="card o-hidden card-hover">
                            ...
                            <div class="card-body pt-0">
                                <ul class="StepProgress">
                                    ...
                                    <li class="StepProgress-item">
                                        <strong>James changed product prices</strong>
                                    </li>
                                    <li class="StepProgress-item">
