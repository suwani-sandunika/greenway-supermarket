...
<head>
    ...
    <title>GreenWay - Category List</title>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            $categoriesRs = MySQL::search("SELECT * FROM category");
                            $noOfCategories = $categoriesRs->num_rows;
                            $itemsPerPage = 10;
                            $noOfPages = ceil($noOfCategories / $itemsPerPage);
                            $offset = ($page - 1) * $itemsPerPage;
                            $categoriesRs = MySQL::search("SELECT * FROM category LIMIT $itemsPerPage OFFSET $offset");
                                ...
                                <div class="table-responsive table-desi">
                                    <table class="table table-striped all-package">
                                        ...
                                        if ($categoriesRs->num_rows == 0) {
                                            ...
                                            while ($category = $categoriesRs->fetch_assoc()) {
                                                $productsRs = MySQL::search("SELECT * FROM product JOIN brand b on b.id = product.brand_id JOIN category c on c.id = b.category_id WHERE category_id = {$category['id']}");
                                                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="javascript:showUpdateCategoryModal('<?= $category['id'] ?>')">
