            ...
            <div class="row">
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <div class="page-image">
                        <img src="assets/images/inner-page/404.png" class="img-fluid blur-up lazyload" alt="" style="height: 400px">
                    </div>
                </div>
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <div class="page-container pass-forgot">
                        <div class="text-center mt-4">
                            ...
                            <a href="index.php" class="btn btn-solid-red">Back Home Page</a>
                        </div>
                    </div>
                </div>
            </div>
